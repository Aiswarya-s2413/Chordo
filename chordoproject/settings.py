"""
Django settings for chordoproject project.
...
ROOT_URLCONF = 'chordoproject.urls'
...
WSGI_APPLICATION = 'chordoproject.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'HOST': 'mydbinstance.cvom800i0b4s.ap-southeast-2.rds.amazonaws.com',
        'PORT': '5432',
    }
}  
...
SITE_ID=1 #indicates we are using default site
...
SESSION_COOKIE_NAME = 'userapp_sessionid'
ADMIN_SESSION_COOKIE_NAME = 'adminapp_sessionid'
...
AWS_STORAGE_BUCKET_NAME = 'mydbinstance'
